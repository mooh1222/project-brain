"""install — 프로젝트에 config + 스킬 2종을 멱등 설치하고 manifest로 추적한다.
...
class InstallTest(unittest.TestCase):
    ...
    def test_existing_config_is_preserved(self):
        ...
        self.assertTrue(self._skill("custom-brain-recall").exists())
        recall = self._skill("custom-brain-recall").read_text(encoding="utf-8")
